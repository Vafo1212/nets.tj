...
export const BusinessServicesData = [
    ...
    {id: 3, img: imgServicesCard3, title: 'Антивирусы', text: 'Управляйте корпоративной связью своих сотрудников. Контролируйте расходы, анализируйте отчёты, подключайте услуги', link: '/directum'}, 
